// ════════════════════════════════════════════════════════════════
// SFX ENGINE Logic — motor desacoplado de datos
// ════════════════════════════════════════════════════════════════
(function initSFXLogic(global) {
  function create({ data, deps }) {
    const { ModuleLoader, Out, MusicEngine, EventBus } = deps;
    let audioCtx = null;
    let sfxGain = null;
  ...
  let hooksBound = false;
    ...
    const SFX_LIST = Array.isArray(data?.sfx_list) && data.sfx_list.length
      ? [...data.sfx_list]
      : [
